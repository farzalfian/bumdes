...
import { MapPin, Phone, Mail, Facebook, Instagram, Twitter, ChevronRight, Send, ArrowUp } from "lucide-react"
...
export default function Footer() {
  ...
  return (
    <footer className="relative bg-gradient-to-b from-primary to-[#3d4f22] text-white overflow-hidden">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div className="lg:col-span-1">
            <div className="flex items-center gap-3 mb-4">
              <div className="w-12 h-12 bg-gradient-to-br from-[#8FA31E] to-[#C6D870] rounded-lg flex items-center justify-center shadow-lg">
                <span className="text-2xl font-bold text-[#556B2F]">B</span>
              </div>
          ...
          <div>
            <h4 className="text-lg font-semibold mb-6 text-[#EFF5D2] flex items-center gap-2">
              <div className="w-1 h-6 bg-gradient-to-b from-[#8FA31E] to-[#C6D870] rounded-full"></div>
              Menu Cepat
            </h4>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex gap-3 text-sm text-[#C6D870] group hover:text-[#EFF5D2] transition-colors duration-300">
                <div className="w-10 h-10 rounded-lg bg-white/5 backdrop-blur-sm flex items-center justify-center flex-shrink-0 group-hover:bg-[#8FA31E] transition-all duration-300">
          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              <button
                ...
                className="w-full px-4 py-3 rounded-lg bg-gradient-to-r from-[#8FA31E] to-[#C6D870] text-white font-semibold hover:shadow-lg hover:shadow-[#8FA31E]/30 transition-all duration-300 flex items-center justify-center gap-2 group hover:scale-[1.02]"
              >
      ...
      <div className="bg-gradient-to-r from-[#556B2F] via-[#8FA31E] to-[#556B2F] h-1 animate-pulse"></div>

      {/* Scroll to top button */}
      {showScrollTop && (
        <button
          onClick={scrollToTop}
          className="fixed bottom-8 right-8 w-12 h-12 rounded-full bg-gradient-to-r from-[#8FA31E] to-[#C6D870] text-white shadow-lg hover:shadow-xl hover:shadow-[#8FA31E]/30 transition-all duration-300 flex items-center justify-center group hover:scale-110 z-50"
