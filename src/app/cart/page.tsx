...
export default function Page() {
  ...
  return (
    <PageTransition>
      <div className="min-h-screen bg-gradient-to-br from-quaternary via-white to-quaternary py-12 px-4">
              ...
              {cart.map((item) => (
                ...
                >
                  <div className="flex gap-6">
                    <div className="relative w-24 h-24 md:w-32 md:h-32 flex-shrink-0 rounded-xl overflow-hidden bg-quaternary border-2 border-tertiary/20">
                      <Image
                        src={item.image}
                        alt={item.name}
                        fill
